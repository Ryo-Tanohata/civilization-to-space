...
QAL の版であれば、リポジトリへは置けない。

**[Gobkit](https://gobkit.itch.io/gobkit-free-dinosaur-pack) は CC0 のままだった**（同日確認）。
骨組みと動きの付いた低ポリの恐竜10体で、GLB。商用利用可・クレジット不要。
**恐竜はここから採れる。** 揺らいだのは Poly Pizza 側の動物である。
...
牙・鼻・毛皮まで読み取れる姿になった。**
**マンモスは素材が要らない。** 2026年9月21日、この試作の比を Unity の
[地表の場面](../design/SURFACE_SCENE_SPEC.md)へ移した。球と円柱の組み立てのまま、
高い肩・下がる背・丸い頭頂・垂れる鼻・巻く牙が読み取れる。素材ファイルは使っていない。
**骨格を落とす必要は、いまのところ無い。**
...
| 3 | 恐竜を素材から採るか | Gobkit が CC0 のままであることは確かめた（7.1）。落として、写真計測の草木と並べて見てから決める |
